...
def main(): 
    ...
    pygame.startScreen() # show the title screen until the user presses a key
    ...
    def runLevel(levels, levelNum):
         ...
         # Track how much the camera has move
         cameraOffsetX = 0
    ...
    def readLevelsFile(filename):
         ...
         def floodFill(mapObj, x, y, oldCharacter, newCharacter):
             ...
             if y > 0 and mapObj[x][y-1] == oldCharacter:
                 ...
                 floodFill(mapObj, x, y-1, oldCharacter, newCharacter) # call u533.
